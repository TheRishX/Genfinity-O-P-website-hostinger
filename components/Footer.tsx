...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-brand-ink text-slate-300 pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-2">
              <img src="https://genfinityoandp.com/wp-content/uploads/2026/03/logo2.png" alt="Genfinity O&P" className="h-12 w-auto max-w-[200px] object-contain object-left brightness-0 invert" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Home', 'Services', 'What to Expect', 'Insurance & Billing', 'Locations', 'About Us', 'Patient Resources', 'Contact'].map((item) => (
                <li key={item}>
                  <Link
                    href={item === 'Home' ? '/' : item === 'Insurance & Billing' ? '/insurance' : `/${item.toLowerCase().replace(/\s+/g, '-')}`}
